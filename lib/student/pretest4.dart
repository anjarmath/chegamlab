...
class Pretest1 extends StatefulWidget {
  const Pretest1({Key? key}) : super(key: key);

  @override
  State<Pretest1> createState() => _Pretest1State();
}

class _Pretest1State extends State<Pretest1> {
  var gambar = [
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
          onPressed: () async {
            ...
            String res =
                await AuthMethods().addNilaiPretest(nilai: total, pertemuan: 4);
            if (res == 'success') {
              showDialog(
                context: context,
                builder: (_) => Dialog(
